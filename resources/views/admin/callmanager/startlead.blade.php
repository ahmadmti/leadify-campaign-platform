                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputState" name="interested" class="form-control">
                                            ...
                                            <option value="sold" @if($lead->interested == 'sold') selected @endif>@lang('module_lead.sold')</option>
                                            <option value="waiting for installation" @if($lead->interested == 'waiting for installation') selected @endif>@lang('module_lead.waiting for installation')</option>
                                            <option value="installed" @if($lead->interested == 'installed') selected @endif>@lang('module_lead.installed')</option>
