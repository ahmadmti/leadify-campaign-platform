...
<li class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <a href="{{ route('admin.schedule.index') }}" class="dropdown-item has-icon">
            <i class="fa fa-calendar-alt"></i> @lang('module_settings.setSchedule')
        </a>
        @endif
...
<li class="dropdown dropdown-list-toggle">
    <a data-toggle="modal" href="#loginRegisterModal" class="btn btn-icon icon-left btn-outline-light"><i
