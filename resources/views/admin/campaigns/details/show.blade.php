                                            ...
                                            <li class="media pt-15">
                                                ...
                                                <div class="media-cta">
                                                    <div class="media-items">
                                                        ...
                                                        <div class="media-item">
                                                            <div class="media-value">{{ $campaignStaffMember->sold_leads }}</div>
                                                            <div class="media-label">@lang('module_lead.sold')</div>
                                                        </div>
                                                        <div class="media-item">
                                                            <div class="media-value">{{ $campaignStaffMember->installed_leads }}</div>
                                                            <div class="media-label">@lang('module_lead.installed')</div>
                                                        </div>
                                                        <div class="media-item">
                                                            <div class="media-value">{{ $campaignStaffMember->waiting_for_installation_leads }}</div>
                                                            <div class="media-label">@lang('module_lead.waiting for installation')</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
