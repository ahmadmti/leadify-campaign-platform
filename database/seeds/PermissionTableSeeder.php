...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run() {
        ...
        $permission = new Permission();
        $permission->name = 'booked_appointment_view';
        $permission->display_name = 'View Booked Appointment';
        $permission->save();

         // Schedule 
        
         $permission = new Permission();
         $permission->name = 'schedule_view';
         $permission->display_name = 'View Schedule';
         $permission->save();
