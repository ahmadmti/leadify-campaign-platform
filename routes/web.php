...
Route::group(['middleware' => ['auth.admin', 'web', 'admin.permission.check'],'namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::match(array('PUT', 'POST'),'check-appointments', ['as' => 'admin.check-appointments', 'uses' => 'AppointmentCalendarController@checkAppointments']);
    Route::match(array('PUT', 'POST'),'check-calls', ['as' => 'admin.check-calls', 'uses' => 'PendingCallbackController@checkCalls']);
    
    Route::get('get-booked-appointments', ['as' => 'admin.appointments.booked', 'uses' => 'BookedAppointmentController@getBookedAppointments']);

    Route::post('check-time', ['as' => 'admin.check-time', 'uses' => 'AppointmentCalendarController@checkAvailableTime']);
    ...
    Route::get('schedule', ['as' => 'admin.schedule.index', 'uses' => 'ScheduleSettingController@index'] );
    
    Route::post('available', ['as' => 'admin.schedule.available', 'uses' => 'ScheduleSettingController@store'] );
    
    Route::post('update', ['as' => 'admin.schedule.update', 'uses' => 'ScheduleSettingController@updateSchedule'] );
    
    Route::get('availableDays', ['as' => 'admin.check-availableDays', 'uses' => 'ScheduleSettingController@availableDays'] );
